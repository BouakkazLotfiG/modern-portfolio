const styles = {
  ...
  heroHeading2:
    "font-bold lg:text-[75px] md:text-[50px] sm:text-[30px] text-[44px] lg:leading-[158.4px] md:leading-[114.4px] sm:leading-[74.4px] leading-[64.4px] uppercase text-white",
  heroDText:
